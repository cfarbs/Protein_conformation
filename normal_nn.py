...
from lib.norm_data import load_normal

class NormalNetwork(unittest.TestCase):
    def setUp(self):
        tr_data, xtr_data, ts_data = load_normal(0.7)
    ...
    def CheckNorm(self, test_name, model_type, hidden_dim, verbose, epochs, batch_size=10, extra_args=None):
        mat, results = mini_batch_sgd(motif=test_name,
    ...
    def StartingNN(self):
        self.CheckNorm(test_name="twoLayerTest", model_type="twoLayer", hidden_dim=[10], verbose=False, epochs=1000)

def main():
    testSuite = unittest.TestSuite()
    testSuite.addTest(NormalNetwork('StartingNN'))
